...
describe("Data types tests ", function() {
  ...
  describe("Case for Prime numbers below 2 and for Negative integers", function() {

    it("should return `No prime numbers below the given input`", function() {
      expect(myApp.getPrimes(1)).toBe('No prime numbers below the given input');
    });
      
    it("should return `No prime numbers below the given input`", function() {
      expect(myApp.getPrimes(-2)).toBe('No prime numbers below the given input');
    });
